...
import com.example.networkpakkages.zonsection.myadapterzong;
import com.example.networkpakkages.zonsection.zongpakkagesactivity;
...
public class ptclpakkagesactivity extends AppCompatActivity {
    ...
    myadapterptcl adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ptclpakkagesactivity);
...
// finally change the color
        ...
        adapter = new myadapterptcl(recycleritems, this);
    ...
    public void getbanneritems() {
        ...
        {
            AdView adView = new AdView(ptclpakkagesactivity.this);
