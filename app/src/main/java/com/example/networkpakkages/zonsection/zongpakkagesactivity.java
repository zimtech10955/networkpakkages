...
public class zongpakkagesactivity extends AppCompatActivity {
    ...
    myadapterzong adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_zongpakkagesactivity);
...
// finally change the color
        ...
        adapter = new myadapterzong(recycleritems, this);
    ...
    public void getbanneritems() {
        ...
        {
            AdView adView = new AdView(zongpakkagesactivity.this);
