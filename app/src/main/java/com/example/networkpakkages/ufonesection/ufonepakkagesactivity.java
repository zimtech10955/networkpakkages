...
public class ufonepakkagesactivity extends AppCompatActivity {
    ...
    myadapterufone adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ufonepakkagesactivity);
...
// finally change the color
        ...
        adapter = new myadapterufone(recycleritems, this);
    ...
    public void getbanneritems() {
        ...
        {
            AdView adView = new AdView(ufonepakkagesactivity.this);
