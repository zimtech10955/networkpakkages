...
public class myadapterufone extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public myadapterufone(List<Object> recycleritems, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case item_data:
                View dataview = LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerowyoufone, parent, false);
