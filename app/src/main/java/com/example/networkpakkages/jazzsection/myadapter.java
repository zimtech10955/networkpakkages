...
public class myadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public myadapter(List<Object> recycleritems, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case item_data:
                View dataview = LayoutInflater.from(parent.getContext()).inflate(R.layout.singlerow, parent, false);
...
if (model.getNetwoork().equals("ufone"))
mvh.subscribe.setBackgroundTintList(context.getResources().getColorStateList(R.color.ufonecolor));
